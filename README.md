...
A funcionalidade de Notificação foi implementada mas a chamada do método foi comentada porque o servidor fornecedor está indisponível: [https://util.devi.tools/api/v1/notify](https://util.devi.tools/api/v1/notify).
